...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-V0-tDOu6.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C_HRQ0YG.js").then((n2) => n2.r),
    import("./start-ByPdy55z.js"),
...
var ROUTER_BASEPATH = "sanika_cakes";
var SERVER_FN_BASE = "/sanika_cakes/_serverFn/";
