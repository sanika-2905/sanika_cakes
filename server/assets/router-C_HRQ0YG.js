...
const appCss = "/sanika_cakes/assets/styles-DBrHdHyG.css";
...
function CartProvider({ children }) {
  ...
  const remove = (id) => setItems((p) => p.filter((i) => i.cake.id !== id));
  const setQty = (id, qty) => setItems((p) => p.map((i) => i.cake.id === id ? { ...i, quantity: Math.max(1, qty) } : i));
  const clear = () => setItems([]);
  const total = items.reduce((s, i) => s + i.cake.price * i.quantity, 0);
  const count = items.reduce((s, i) => s + i.quantity, 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ctx$1.Provider, { value: { items, add, remove, setQty, clear, total, count }, children });
}
const useCart = () => {
...
function ThemeProvider({ children }) {
  ...
  reactExports.useEffect(() => {
    const saved = typeof window !== "undefined" && localStorage.getItem("sanika-theme");
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 glass-strong", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex h-18 items-center justify-between gap-4 px-4 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-display text-2xl font-bold", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full bg-gradient-primary text-primary-foreground shadow-soft", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cake, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Sanika Cakes" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: toggle, "aria-label": "Toggle theme", className: "rounded-full", children: theme === "dark" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "h-5 w-5" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/cart", className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", "aria-label": "Cart", className: "rounded-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShoppingBag, { className: "h-5 w-5" }) }),
          count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -right-1 -top-1 grid h-5 min-w-5 place-items-center rounded-full bg-gradient-primary px-1 text-xs font-semibold text-primary-foreground shadow-soft", children: count })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", className: "md:hidden rounded-full", onClick: () => setOpen((o) => !o), children: open ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-5 w-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "h-5 w-5" }) })
      ] })
    ] }),
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t md:hidden animate-fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "container mx-auto flex flex-col gap-1 px-4 py-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/signup", onClick: () => setOpen(false), className: "rounded-xl bg-gradient-primary px-4 py-3 text-center text-sm font-semibold text-primary-foreground", children: "Sign up" })
    ] }) })
  ] });
}
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 border-t bg-gradient-soft", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto grid gap-10 px-4 py-14 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 font-display text-2xl font-bold", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grid h-10 w-10 place-items-center rounded-full bg-gradient-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Cake, { className: "h-5 w-5" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Sanika Cakes" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Handcrafted cakes baked with love. Order sweet happiness today." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.instagram.com/_sanika.cakes_?igsh=M3J1d21id2t1aXNm", "aria-label": "Instagram", className: "grid h-10 w-10 place-items-center rounded-full glass hover:bg-gradient-primary hover:text-primary-foreground transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Instagram, { className: "h-4 w-4" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://www.facebook.com/share/19syC5zBkU/", "aria-label": "Facebook", className: "grid h-10 w-10 place-items-center rounded-full glass hover:bg-gradient-primary hover:text-primary-foreground transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Facebook, { className: "h-4 w-4" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-4 text-sm font-semibold uppercase tracking-wider", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cakes", className: "hover:text-primary", children: "Cakes" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/cart", className: "hover:text-primary", children: "Cart" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-4 text-sm font-semibold uppercase tracking-wider", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 text-sm text-muted-foreground", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 mt-0.5 text-primary" }),
            " +91 9130249492"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4 mt-0.5 text-primary" }),
            " "
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "mb-4 text-sm font-semibold uppercase tracking-wider", children: "Notice" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl glass p-4 text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-primary", children: "Pickup Only" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mt-1", children: "Delivery is not available. Please collect your cake from our store." })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto flex flex-col items-center justify-between gap-2 px-4 py-5 text-xs text-muted-foreground md:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Sanika Cakes. All rights reserved."
      ] }),
...
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md rounded-3xl glass-strong p-10 text-center shadow-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "We couldn't find that sweet treat. Try our delicious menu instead." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "inline-flex items-center justify-center rounded-full bg-gradient-primary px-6 py-3 text-sm font-semibold text-primary-foreground shadow-soft hover:opacity-90", children: "Back home" }) })
  ] }) });
}
function ErrorComponent({ error, reset }) {
  console.error(error);
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md rounded-3xl glass-strong p-10 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-semibold", children: "Something went wrong" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 flex flex-wrap justify-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => {
        router2.invalidate();
        reset();
      }, className: "rounded-full bg-gradient-primary px-5 py-2 text-sm font-medium text-primary-foreground", children: "Try again" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/", className: "rounded-full border px-5 py-2 text-sm font-medium", children: "Go home" })
    ] })
  ] }) });
}
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CartProvider, { children: [
...
const $$splitComponentImporter$8 = () => import("./signup-CBA7I_DF.js");
const Route$8 = createFileRoute("/signup")({
  head: () => ({
    meta: [{
      title: "Sign up — Sanika Cakes"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./reset-password-Cv5jV7TS.js");
const Route$7 = createFileRoute("/reset-password")({
  head: () => ({
    meta: [{
      title: "Reset password — Sanika Cakes"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./login-CmjCBbHe.js");
const Route$6 = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "Login — Sanika Cakes"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./forgot-password-CzAJhR2w.js");
const Route$5 = createFileRoute("/forgot-password")({
  head: () => ({
    meta: [{
      title: "Forgot password — Sanika Cakes"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./contact-CReRfz7i.js");
const Route$4 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      title: "Contact — Sanika Cakes"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./cart-DLNNI_Hq.js");
const Route$3 = createFileRoute("/cart")({
  head: () => ({
    meta: [{
      title: "Cart — Sanika Cakes"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./cakes-BcWH6czG.js");
const Route$2 = createFileRoute("/cakes")({
  head: () => ({
    meta: [{
      title: "All Cakes — Sanika Cakes"
    }, {
      name: "description",
      content: "Browse birthday, wedding, chocolate, photo, cupcake and custom cakes from Sanika Cakes."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-B3CNa9NG.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Luxurious handcrafted pink bakery cakes for birthdays, weddings and more. Pickup only."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const birthday = "/sanika_cakes/assets/cake-birthday-OJlk_uBW.jpg";
const wedding = "/sanika_cakes/assets/cake-wedding-aadoji_F.jpg";
const chocolate = "/sanika_cakes/assets/cake-chocolate-BsJQ8XrB.jpg";
const cupcakes = "/sanika_cakes/assets/cake-cupcakes-BviQ23IT.jpg";
const photo = "/sanika_cakes/assets/cake-photo-DmaerU0_.jpg";
const custom = "/sanika_cakes/assets/cake-custom-BDTdiddS.jpg";
const strawberry = "/sanika_cakes/assets/cake-strawberry-tWaRkauY.jpg";
const categories = [
  "Birthday Cakes",
  "Wedding Cakes",
  "Chocolate Cakes",
...
const getCake = (id) => cakes.find((c) => c.id === id);
const $$splitNotFoundComponentImporter = () => import("./cakes._cakeId-73Bsfoka.js");
const $$splitComponentImporter = () => import("./cakes._cakeId-C-6OgAFs.js");
const Route2 = createFileRoute("/cakes/$cakeId")({
...
const CakesRoute = Route$2.update({
  id: "/cakes",
  path: "/cakes",
  getParentRoute: () => Route$9
});
...
const CakesCakeIdRoute = Route2.update({
  id: "/$cakeId",
  path: "/$cakeId",
  getParentRoute: () => CakesRoute
});
const CakesRouteChildren = {
  CakesCakeIdRoute
};
